...
dog.o: dog.c ../include/type.h ../include/stdio.h
	$(CC) $(CFLAGS) -o $@ $<

dog : dog.o start.o $(LIB)
	$(LD) $(LDFLAGS) -o $@ $?

delete.o: delete.c ../include/type.h ../include/stdio.h
	$(CC) $(CFLAGS) -o $@ $<

delete : delete.o start.o $(LIB)
	$(LD) $(LDFLAGS) -o $@ $?

cal.o: cal.c ../include/type.h ../include/stdio.h
	$(CC) $(CFLAGS) -o $@ $<

cal : cal.o start.o $(LIB)
	$(LD) $(LDFLAGS) -o $@ $?
